<template>
    <div class="main-wrapper">
        <a-layout>
            <a-layout-sider v-model:collapsed="collapsed" breakpoint="lg" collapsible :trigger="null">
                <div class="logo">
                    <div class="icon"></div>
            ...
            <a-layout>
                <a-layout-header>
                    ...
                    <a-breadcrumb>
                        <template v-for="routeItem in breadcrumbMenus" :key="routeItem?.name">
                            <a-breadcrumb-item>
...
const onClickMenu = (menu: { item: any; key: string; keyPath: Array<string> }) => {
    router.push({ name: menu.key });
};
const onOprateMenu = (menu: { item: any; key: string; keyPath: Array<string> }) => {
    switch (menu.key) {
        case "logout":
            user.clear();
